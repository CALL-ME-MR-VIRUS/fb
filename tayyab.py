...
\033[1;93m
\033[1;93m🇸​​​​​🇭​​​​​🇦​​​​​🇰​​​​​🇪​​​​​🇪​​​​​🇧​​​​​🔥╭╬──────────────────────────────────╬╮🔥
\033[0;94m  ⚡ ✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗 ✪ 𝕸𝖗. VIRUS ✬⚡
\033[0;94m  ⚡ ✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ✪ MR VIRUS007 ✬⚡
...
jalan("\033[1;96m•◈•────────────•◈•\033[1;99mTAYYAB\033[1;99m•◈•────────────•◈•")                        
...
jalan("\033[1;93m Welcome to VIRUS Creations")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/MR.VIRUS.007.OFICIAL')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;42mUpdate TAYYAB"																														
